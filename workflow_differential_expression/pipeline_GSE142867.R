#' ---
#' title: "Analysis of Hypoxia and Normoxia on RNA-Seq (GSE142867)"
#' output: 
...
#' ---
#' 
#' Full pipeline of DEA with Glimma - Comparing gene expression of Normoxia vs Hypoxia.
#' 
#' This experiment performed RNA-sequencing on erythropoietic cells cultured in normoxia or hypoxia at days 3,7, and 10. Has found numerous expression changes induced by hypoxia, including the canonical hypoxia targets as well as a number of genes encoding genes involved in epigenetic processes.
#' 	
...
#' 
#' 
#' - Check the preprocessing of Fasta files with: 
#' 
...
#' 
#' First, we download data for GSE142867 from [GEO](https://www.ncbi.nlm.nih.gov/geo/).
#' 
...
legend("topright",levels(data.GSE142867$condition),col=seq(along=levels(data.GSE142867$condition)),pch=15,cex=1) # ERROR 
identify(mds) 
>>>>>>> 9a555b19cf63ad35e52efe473f4a7c66f9553c0a
